...
module GraphOld =
    ...
    let addVertex vertexId vertex (graph: GraphOld<'v, 'e>) =
    ...
    let removeVertex vertexId (graph: GraphOld<'v, 'e>) =
        let edges =
            graph.AdjacencyList
    ...
    let addEdge fromVertexId toVertexId edgeId edge (graph: GraphOld<'v, 'e>) =
    ...
    let removeEdge edgeId (graph: GraphOld<'v, 'e>) =
    ...
    let getNeighbors vertexId (graph: GraphOld<'v, 'e>) =
        graph.AdjacencyList
        |> AdjacencyList.getNeighbors vertexId
        |> Map.toSeq
    ...
    let getNeighborIds vertexId (graph: GraphOld<'v, 'e>) =
        graph.AdjacencyList
        |> AdjacencyList.getNeighbors vertexId
        |> Map.toList
        |> List.map fst
    ...
    let mapVertices f (graph: GraphOld<'v, 'e>) =
    ...
    let mapEdges f (graph: GraphOld<'v, 'e>) =

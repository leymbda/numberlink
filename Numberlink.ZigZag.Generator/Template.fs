...
module Template =
    ...
    let withTerminalGeneration enabled template =
    ...
    let withBridgeGeneration enabled template =
    ...
    let addEdge edge kind vertex1 vertex2 template = result {
    ...
    let removeVertex vertex template =
